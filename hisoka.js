 ...
 * Contact Me on wa.me/6281386383559
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            case "donate":
                {
                    hisoka.sendMessage(
                        m.chat,
                        {
                            image: { url: "https://telegra.ph/file/74fd634010128be37972c.jpg" },
                            caption: `*Hai Kak ${m.pushName}*\n\n Bot Foxzy Prices\n⭔ 10k Per Group via Qris All Payment/Gopay/Ovo/Dana,dll Permanen\n⭔ 20k via pulsa 5 bulan\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Qris All Pay/gopay/dana/ovo/pulsa+10k\n\nFor more details, you can chat with the owner\nhttps://wa.me/6281386383559 (Owner)\n\nDonate For Me : \n\n⭔ OVO/DANA : 081386383559\n⭔ Qris All Pay : CHAT OWNER`,
                        },
                        { quoted: m }
                    )
                }
            ...
            case "sc":
                {
                    m.reply("Script : Cari Aja Yt Sendiri\n\n Cari Yt Bwangg\n\nDonate : 6281386383559 (Gopay Ovo Dana)\nGithub : https://github.com/foxzyganzz\n\n Dont Forget Donate")
                }
                break
            case "chat":
                {
                    ...
                    if (args[0] === "mute") {
                        ...
                        hisoka
                            .chatModify({ clear: { message: { id: m.quoted.id, fromMe: true } } }, m.chat, [])
                            .then((res) => m.reply(jsonformat(res)))
                            .catch((err) => m.reply(jsonformat(err)))
                    }
                }
...
`
            ...
            case "ephemeral":
                {
                    ...
                    if (args[0] === "enable") {
                        await hisoka
                            .sendMessage(m.chat, { disappearingMessagesInChat: WA_DEFAULT_EPHEMERAL })
                            .then((res) => m.reply(jsonformat(res)))
                            .catch((err) => m.reply(jsonformat(err)))
            ...
            case "bcgroup":
                {
                    if (!isCreator) throw mess.owner
                    if (!text) throw `Text mana?\n\nExample : ${prefix + command} FoxzyWasHere`
...
⭔ Url : ${anu.url}`,
            ...
            case "ytaudio":
                {
                    ...
                    if (media[0].formattedSize.split("MB")[0] >= 100.0) return m.reply("File Melebihi Batas" + util.format(media))
            ...
            case "ytvideo":
                {
                    ...
                    hisoka.sendMessage(
                        m.chat,
                        { video: { url: media[0].url }, fileName: `${title}.mp4`, mimetype: "video/mp4", caption: `⭔ Title : ${title}\n⭔ File Size : ${media[0].formattedSize}\n⭔ Url : ${url}\n⭔ Ext : MP4\n⭔ Resolusi : ${args[1] || "360p"}` },
                        { quoted: m }
                    )
                }
                break
            ...
            case "nomorhoki":
                {
                    if (!Number(text)) throw `Example : ${prefix + command} 6281386383559`
            ...
            case "ramaljodoh":
                {
                    if (!text) throw `Example : ${prefix + command} Dika, 7, 7, 2000, Novia, 16, 11, 2004`
            ...
            case "cocoknama":
                {
                    if (!text) throw `Example : ${prefix + command} Dika, 7, 7, 2000`
            ...
            case "peruntungan":
                {
                    if (!text) throw `Example : ${prefix + command} DIka, 7, 7, 2000, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
            ...
            case "juzamma":
                {
                    if (args[0] === "pdf") {
                        ...
                        hisoka.sendMessage(
                            m.chat,
                            {
                                document: { url: "https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx" },
                        ...
                        hisoka.sendMessage(
                            m.chat,
                            {
                                document: { url: "https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx" },
                        ...
                        hisoka.sendMessage(
                            m.chat,
                            {
                                document: { url: "https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx" },
            ...
            case "alquran":
                {
                    ...
                    let res = await fetchJson(`https://api.lolhuman.xyz/api/quran/${args[0]}/${args[1]}?apikey=FoxzyApi`)
                    let txt = `*Arab* : ${res.result.ayat[0].arab}
*Latin* : ${res.result.ayat[0].latin}
*Indonesia* : ${res.result.ayat[0].indonesia}

( Q.S ${res.result.surah} : ${res.result.ayat[0].ayat} )`
                    m.reply(txt)
    ...
    .join("\n\n")}`
        : ""
            ...
            case "?":
                {
                    anu = `┏━━>[ Info Botz ]
┣ HALO KAK WELCOME,NAMA SAYA FOXZY BOTZ
┣ NOTE FITUR BOTZ SETIAP HARINYA AKAN UPDATE:V

┣ • *Name Bot* : FoxzyPawBotz
┣ • *Baterai* : Tidak Terdeteksi
┣ • *Version* : 1.0.0
┣ • *Nama Own* : FoxzyWasHere
┗━━━━━━━━━━━>
   ┣ • *Website* : https://foxzywashere.my.id/
   ┣ • *Instagram* : https://instagram.com/foxzywashere
                                    ...
                                    hydratedButtons: [
                                        {
                                            urlButton: {
                                                displayText: "Source Code",
                                                url: "https://github.com/foxzyganzz NOTE SC MASIH PRIV",
                                            },
                                        },
                                        {
                                            callButton: {
